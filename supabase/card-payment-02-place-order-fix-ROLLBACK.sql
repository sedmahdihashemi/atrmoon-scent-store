-- =====================================================================
-- بازگرداندن place_order به نسخه‌ی قبل از این اصلاح (فقط bale می‌شناخت،
-- card_transfer رد می‌شد با خطای invalid_payment_method). فقط در صورت
-- نیاز واقعی اجرا کنید.
-- =====================================================================
